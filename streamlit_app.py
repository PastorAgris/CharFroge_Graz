...
with col2:
    ...
    with col21:
        st.number_input("Initiative", -10, 10, data["basevals"]["Init"], key="base_init", on_change=save_character)
    with col22:
        st.number_input("Gesundheit", -10, 10, data["basevals"]["Ges"], key="base_ges", on_change=save_character)
    with col23:
        st.number_input("Resistenz", -10, 10, data["basevals"]["Resis"], key="base_resis", on_change=save_character)
